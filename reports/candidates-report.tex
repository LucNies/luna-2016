...
\subsection{Segmentation using fully convolutional network}
Long et al. \cite{long}. %Lung segmentation \& Nodule segmentation (I thought we might just use "segmentation" in the header)
